...
//var App = React.createFactory(require('../../app/components/app.js'));
var Root = React.createFactory(require('../views/root'));
...
function serverRouteHandler(request, reply) {
    var props = {};
    var markup = DOCTYPE + React.renderToStaticMarkup(Root(props));
    reply(markup);
